...
_unary_ops = {
	('PRE_INC', 'integer') : 'integer',
	('POST_INC', 'integer') : 'integer',
	('-', 'integer') : 'integer',
	('PRE_DEC', 'integer') : 'integer',
	('POST_DEC', 'integer') : 'integer',
	('^', 'integer') : 'integer',

	('PRE_INC', 'float')   : 'float',
	('POST_INC', 'float')   : 'float',
	('PRE_DEC', 'float')   : 'float',
	('POST_DEC', 'float')   : 'float',
	('-', 'float')   : 'float',
